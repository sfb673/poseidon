# This file is part of the POSEIdON gem.
...
# License along with POSEIdON. If not, see
# <http://www.gnu.org/licenses/>.

# This module contains all the mixins that can be added to classes.
# These mixins add RDF export functionality to them.
module Poseidon
